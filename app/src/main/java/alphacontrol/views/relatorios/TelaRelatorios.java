...
public class TelaRelatorios extends JFrame {
    ...
    private JPanel criarPainelFiltros() {
        ...
        rbProdutos = new RoundedRadioButton("Produtos Mais Vendidos");
    ...
    // Campo de data aprimorado para parecer um input real (Fundo branco e borda reativa)
    static class RoundedTextField extends JFormattedTextField {
        ...
        protected void paintComponent(Graphics g) {
            ...
            // Fundo Branco para parecer input
    ...
    static class PaddedCellRenderer extends DefaultTableCellRenderer {
        ...
        public static void apply(JTable table, int col, int alignment) { table.getColumnModel().getColumn(col).setCellRenderer(new PaddedCellRenderer(alignment)); }
    }
}