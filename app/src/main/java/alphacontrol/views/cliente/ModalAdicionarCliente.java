...
public class ModalAdicionarCliente extends JDialog {
    ...
    public ModalAdicionarCliente(JFrame parent) {
        ...
        gbc.gridx = 1;
        txtCpf = criarCampo(begeClaro, marromClaro, marromEscuro);
        ...
        gbc.gridx = 1;
        txtTelefone = criarCampo(begeClaro, marromClaro, marromEscuro);
        ...
        gbc.gridx = 1;
        txtCep = criarCampo(begeClaro, marromClaro, marromEscuro);
        ...
        gbc.gridx = 1;
        txtRua = criarCampo(begeClaro, marromClaro, marromEscuro);
        ...
        gbc.gridx = 1;
        txtBairro = criarCampo(begeClaro, marromClaro, marromEscuro);
        ...
        gbc.gridx = 1;
        txtNumero = criarCampo(begeClaro, marromClaro, marromEscuro);
